const C="lena-recepttar-studio-49-shell";
const SHELL=["./","./index.html","./styles.css?v=29","./app.js?v=42","./data.js?v=24","./readable-data.js?v=34","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
