const C="lena-recepttar-studio-50-shell";
const SHELL=["./","./index.html","./styles.css?v=30","./app.js?v=43","./data.js?v=24","./readable-data.js?v=34","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
