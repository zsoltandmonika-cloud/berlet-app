const C="lena-recepttar-25-shell";
const SHELL=["./","./index.html","./styles.css?v=25","./app.js?v=25","./data.js?v=24","./readable-data.js?v=25","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
