...
$("#mobileWhatCook").onclick=openWhatCook;
$("#mobileHomeStock").onclick=openStudioStock;
$("#mobileTime").onclick=()=>openWhatCookWith("Kb. 30 percünk van, 4 főre szeretnénk valamit. ");
$("#mobileAvoid").onclick=()=>openWhatCookWith("4 főre főzünk. Ma kerüljük: ");
$("#mobilePersonal").onclick=openWhatCook;
